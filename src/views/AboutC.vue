...
<h6  class="text-black">Cultural Affairs and Sport</h6>
  ...
  <p>Duties: Human Resource Admin Support Working with Persal system under the following fields Housing Leave administration PAY interns payslip processing Overtime, Performance Management </p>
...
<h6  class="text-black">Promoter</h6>
  <h6></h6>
  <p>Promoting ciggarets for retail stores, influencing customers to buy ciggarets that are associated with BAT</p>
    </div> <hr>
<div class="my-3 text-black">
 <div>
<h4 class="text-black">Lifechoices Studio</h4>
<h6  class="text-black">Web developer Intern/Student</h6>
<p>Duties: Creating website based projects using programming languages that we are learning at the academy. Place for upskilling myself. Attending professional development trainigs and boosting my soft skills</p>
    </div>
</div>
</div>
</div>
