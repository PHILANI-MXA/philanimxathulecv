<template>
<div class="container h-100" id="education">
    <h2 class="fw-bolder bg-black p-3">Education</h2>
        <div class="row">
            <div class="col-md-6">
...
<div class="col-md-6">
<h4>6 month coding intensive bootcamp</h4>
<h6>Lifechoices 6 month intensive coding</h6>
    <p>Bachelor pass</p>
    <p>Subjects</p>
    <ul class="list-unstyled">
    <li>127</li>
...
<p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis aut illum temporibus voluptas ipsa reiciendis quisquam esse mollitia harum dolores.</p></div>
</div>
