                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-unstyled text-black">
                        <li>
                            ...
                            <div class="progress ">
                                <div class="progress-bar bg-black" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </li>
                        <li>
                            <p class="d-flex justify-content-between my-0">
                            ...
                            <div class="progress ">
                                <div class="progress-bar bg-black" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </li>
                        <li>
                            <p class="d-flex justify-content-between my-0">
                        ...
                        <li>
                            ...
                            <div class="progress ">
                                <div class="progress-bar bg-black" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </li>
                         <li>
                            <p class="d-flex justify-content-between my-0">
                 ...
                 <ul class="list-unstyled text-black">
                        <li>
                         ...
                         <li>
                            ...
                            <div class="progress ">
                                <div class="progress-bar bg-black" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </li>
                         <li>
                            <p class="d-flex justify-content-between my-0">
